...
Scholarships: National Scholarship (first 3\%), Zhiyuan Honor Scholarships (first 5\%), SJTU OutStanding Undergraduate Scholarship.
...
\twopartheader{\textbf{Zhiyuan Honor Scholarships} (first 5\%)}{2024, 2025}
